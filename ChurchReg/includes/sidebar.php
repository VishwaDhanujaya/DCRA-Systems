    ...
    <div class="py-5 px-3 space-y-6">
        ...
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a href="<?= BASE_URL ?>pending-review" <?= ($current_page === 'pending_review.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[40px] px-3 py-2 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'pending_review.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 opacity-75" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
                    Pending Review
                </a>
                <a href="<?= BASE_URL ?>certificates" <?= ($current_page === 'certificates.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[40px] px-3 py-2 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'certificates.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 opacity-75" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
        ...
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a href="<?= BASE_URL ?>logout" class="flex items-center min-h-[40px] px-3 py-2 text-xs font-bold rounded-lg text-primary hover:bg-primary/10 focus:outline-none focus:ring-2 focus:ring-primary/40 font-heading transition-all duration-150 mt-1">
