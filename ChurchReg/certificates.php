<?php
/**
 * Issued Certificates - Church Registration Management System
    ...
    <div class="max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <h2 class="text-xl sm:text-2xl font-bold text-slate-900 font-heading tracking-tight mt-0.5">Issued Certificates</h2>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            ...
            <div class="relative overflow-hidden bg-white rounded-2xl p-5 border border-slate-200/90 shadow-2xs flex flex-col justify-between border-t-4 border-t-[#4E0000]">
                <div>
                    <p class="text-xs font-semibold text-slate-400 font-inter uppercase tracking-wider">Total Active</p>
            ...
            <div class="relative overflow-hidden bg-white rounded-2xl p-5 border border-slate-200/90 shadow-2xs flex flex-col justify-between border-t-4 border-t-[#4E0000]">
                <div>
                    <p class="text-xs font-semibold text-slate-400 font-inter uppercase tracking-wider">Expiring Soon</p>
            ...
            <div class="relative overflow-hidden bg-white rounded-2xl p-5 border border-slate-200/90 shadow-2xs flex flex-col justify-between border-t-4 border-t-[#4E0000]">
                <div>
                    <p class="text-xs font-semibold text-slate-400 font-inter uppercase tracking-wider">Expired</p>
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">7</h3>
                </div>
            </div>

            <!-- Card 4: Issued This Month -->
            <div class="relative overflow-hidden bg-white rounded-2xl p-5 border border-slate-200/90 shadow-2xs flex flex-col justify-between border-t-4 border-t-[#4E0000]">
                <div>
                    <p class="text-xs font-semibold text-slate-400 font-inter uppercase tracking-wider">Issued This Month</p>
        ...
        <!-- Certificate Registry Card / Table -->
        <div class="bg-white rounded-2xl border border-slate-200/90 shadow-2xs overflow-hidden">
            
            <div class="p-5 border-b border-slate-100 flex items-center justify-between">
                <h3 class="text-base font-bold text-slate-900 font-heading">Certificate Registry</h3>
            </div>
                ...
                <table class="w-full text-left text-xs font-inter border-collapse min-w-[1100px]">
                    <thead>
                        <tr class="bg-[#F5ECE2]/80 border-b border-slate-200/70 text-[10px] font-bold text-slate-400 uppercase font-heading tracking-wider">
                            <th scope="col" class="py-3.5 px-5 font-bold">CERTIFICATE ID</th>
                            ...
                            <th scope="col" class="py-3.5 px-5 font-bold">ISSUED DATE</th>
                            <th scope="col" class="py-3.5 px-5 font-bold">EXPIRY DATE</th>
                    ...
                    <tbody class="divide-y divide-slate-100 text-slate-700">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            <td class="py-4 px-5 font-mono text-slate-800 font-bold">CERT-2634</td>
                            ...
                            <td class="py-4 px-5 text-slate-500">25 Mar 2026</td>
                            <td class="py-4 px-5 text-slate-500">25 Mar 2026</td>
                            <td class="py-4 px-5">
                        ...
                        <!-- Row 2 -->
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            <td class="py-4 px-5 font-mono text-slate-800 font-bold">CERT-2631</td>
                            ...
                            <td class="py-4 px-5 text-slate-500">20 Mar 2026</td>
                            <td class="py-4 px-5 text-slate-500">20 Mar 2026</td>
                            <td class="py-4 px-5">
                        ...
                        <!-- Row 3 -->
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            <td class="py-4 px-5 font-mono text-slate-800 font-bold">CERT-2629</td>
                            ...
                            <td class="py-4 px-5 text-slate-500">15 Mar 2026</td>
                            <td class="py-4 px-5 text-slate-500">15 Mar 2026</td>
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-[#DCFCE7] text-[#15803D]">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#16A34A]"></span>
                        ...
                        <!-- Row 4 -->
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            <td class="py-4 px-5 font-mono text-slate-800 font-bold">CERT-2628</td>
                            ...
                            <td class="py-4 px-5 text-slate-600">New Registration</td>
                            <td class="py-4 px-5 text-slate-500">12 Mar 2026</td>
                            <td class="py-4 px-5 text-slate-500">12 Mar 2026</td>
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-[#FEF3C7] text-[#92400E]">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#D97706]"></span>
                        ...
                        <!-- Row 5 -->
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            <td class="py-4 px-5 font-mono text-slate-800 font-bold">CERT-2625</td>
                            ...
                            <td class="py-4 px-5 text-slate-600">Renewal</td>
                            <td class="py-4 px-5 text-slate-500">11 Mar 2026</td>
                            <td class="py-4 px-5 text-slate-500">11 Mar 2026</td>
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-[#DCFCE7] text-[#15803D]">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#16A34A]"></span>
                        ...
                        <!-- Row 6 -->
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            <td class="py-4 px-5 font-mono text-slate-800 font-bold">CERT-2619</td>
                            ...
                            <td class="py-4 px-5 text-slate-600">New Registration</td>
                            <td class="py-4 px-5 text-slate-500">05 Mar 2026</td>
                            <td class="py-4 px-5 text-slate-500">05 Mar 2026</td>
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-[#DCFCE7] text-[#15803D]">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#16A34A]"></span>
        ...
        <div class="flex items-center justify-end space-x-3 text-xs font-semibold font-heading">
            ...
            <button class="px-4 py-2.5 bg-[#13273F] hover:bg-[#0d1c2e] text-white rounded-xl shadow-2xs transition-colors flex items-center gap-1.5">
                <svg class="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
