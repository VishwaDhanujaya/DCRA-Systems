<?php
/**
 * Entry Visa Recommendations Page
 * Department of Christian Religious Affairs
 * Visa Recommendation Letter Management System
 */

$page_title = "Entry Visa Recommendations";

require_once __DIR__ . '/includes/header.php';
require_once __DIR__ . '/includes/sidebar.php';

// Entry Visa Applications Dataset
$applications = [
    [
        'id' => 'VLS-2634',
        ...
        'stage' => 'Final Review',
        'stage_step' => 'Step 4/5',
        'stage_badge' => 'bg-amber-50 text-amber-700 border-amber-200',
        'status' => 'Pending',
    ...
    [
        'id' => 'VLS-2630',
        'name' => 'Fr. Michael Fernando',
        'church' => "St. Joseph's Church • Negombo",
        'passport' => 'KL9283741',
        'country' => '🇮🇹 Italy',
    ...
    [
        'id' => 'VLS-2625',
        'name' => 'Sr. Teresa Benedict',
        'church' => "Convent of Mercy • Chilaw Diocese",
        'passport' => 'GH8273645',
        'country' => '🇮🇳 India',
        'stage' => 'MOD Security',
        'stage_step' => 'Step 3/5',
    ...
    [
        'id' => 'VLS-2620',
        'name' => 'Fr. Paul Rodriguez',
        'church' => "Sacred Heart Cathedral • Jaffna",
        'passport' => 'AB9182736',
        'country' => '🇵🇭 Philippines',
        'stage' => 'Letters Issued',
        'stage_step' => 'Step 5/5',
        'stage_badge' => 'bg-emerald-50 text-emerald-700 border-emerald-200',
        'status' => 'Completed',
...
<main class="flex-1 overflow-y-auto p-3.5 sm:p-6 lg:p-8 bg-[#FDFBF9]">
    <div class="max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <span class="text-xs font-normal text-slate-400 font-inter">Home / Visa Types / Entry Visa</span>
                <h2 class="text-xl sm:text-2xl font-bold text-slate-900 font-heading tracking-tight mt-0.5">Entry Visa Recommendations</h2>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div class="relative overflow-hidden bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
                ...
                <div>
                    <p class="text-xs font-medium text-slate-400 font-inter">Total Entry Visas</p>
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">521</h3>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">28</h3>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">12</h3>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">467</h3>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/90 shadow-2xs overflow-hidden">
            <div class="p-5 border-b border-slate-100 flex items-center justify-between">
                <h3 class="font-bold text-slate-900 font-heading text-lg">Entry Visa Applications</h3>
                <span class="text-xs text-slate-500 font-inter">Showing <strong class="font-semibold text-slate-800">4</strong> active entry visa records</span>
            </div>
