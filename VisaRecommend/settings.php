    ...
    <div class="max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <button type="button" class="bg-primary hover:bg-primary-dark text-white font-medium text-xs px-5 py-2 h-10 sm:h-9 min-h-[40px] rounded-lg flex items-center justify-center gap-2 shadow-xs transition-colors font-inter cursor-pointer">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div class="lg:col-span-8 space-y-6">
                ...
                <div class="bg-white rounded-xl p-6 border border-slate-200/80 shadow-xs space-y-5 relative overflow-hidden">
                    <div class="absolute top-0 inset-x-0 h-1 bg-primary"></div>

                    <div class="flex items-center justify-between border-b border-slate-200 pb-4">
                        <div>
                            <h3 class="text-base font-bold text-slate-900 font-heading">Profile Information</h3>
                            <p class="text-xs text-slate-500 font-inter mt-0.5">Manage your personal account details and official staff credentials.</p>
                        </div>
                        <span class="bg-primary-soft text-primary border border-primary/20 rounded-full text-[10px] px-2.5 py-0.5 font-bold uppercase tracking-wider font-heading whitespace-nowrap">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 border border-slate-200">
                        ...
                        <button type="button" class="border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 text-xs font-medium px-3.5 py-2 rounded-lg transition-colors font-inter min-h-[40px] shadow-3xs cursor-pointer">
                            Change Photo
                        </button>
                    </div>
                    ...
                    <div class="space-y-4 font-inter">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" value="Admin User" class="w-full rounded-lg bg-white border-slate-300 text-xs font-inter py-2 px-3 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all h-10 sm:h-9 min-h-[44px] text-slate-800">
                            </div>
                            <div>
                                ...
                                <input type="email" value="admin@christianaffairs.gov.lk" class="w-full rounded-lg bg-white border-slate-300 text-xs font-inter py-2 px-3 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all h-10 sm:h-9 min-h-[44px] text-slate-800">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" value="+94 77 123 4567" class="w-full rounded-lg bg-white border-slate-300 text-xs font-inter py-2 px-3 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all h-10 sm:h-9 min-h-[44px] text-slate-800">
                            </div>
                            <div>
                                ...
                                <input type="text" value="Senior Systems Administrator" class="w-full rounded-lg bg-white border-slate-300 text-xs font-inter py-2 px-3 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all h-10 sm:h-9 min-h-[44px] text-slate-800">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" value="Department Headquarters - Colombo 03" class="w-full rounded-lg bg-white border-slate-300 text-xs font-inter py-2 px-3 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all h-10 sm:h-9 min-h-[44px] text-slate-800">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-6 border border-slate-200/80 shadow-xs space-y-5 relative overflow-hidden">
                    ...
                    <div class="flex items-center justify-between border-b border-slate-200 pb-4">
                        <div>
                            <h3 class="text-base font-bold text-slate-900 font-heading">Security & Password</h3>
                    ...
                    <div class="space-y-4 font-inter">
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="password" placeholder="••••••••" class="w-full rounded-lg bg-white border-slate-300 text-xs font-inter py-2 px-3 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all h-10 sm:h-9 min-h-[44px] text-slate-800">
                            </div>
                            <div>
                                <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-wider font-heading mb-1.5">NEW PASSWORD</label>
                                <input type="password" placeholder="Enter new password" class="w-full rounded-lg bg-white border-slate-300 text-xs font-inter py-2 px-3 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all h-10 sm:h-9 min-h-[44px] text-slate-800">
                            </div>
                            <div>
                                ...
                                <input type="password" placeholder="Confirm new password" class="w-full rounded-lg bg-white border-slate-300 text-xs font-inter py-2 px-3 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary/20 focus:border-primary transition-all h-10 sm:h-9 min-h-[44px] text-slate-800">
                            </div>
                        </div>

                        <!-- 2FA Toggle Switch -->
                        <label class="flex items-center justify-between p-4 border border-slate-200 rounded-xl bg-slate-50 cursor-pointer min-h-[50px]">
                            <div>
                ...
                <div class="bg-white rounded-xl p-6 border border-slate-200/80 shadow-xs space-y-5 relative overflow-hidden">
                    ...
                    <div class="flex items-center justify-between border-b border-slate-200 pb-4">
                        <div>
                            <h3 class="text-base font-bold text-slate-900 font-heading">Notification Preferences</h3>
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white rounded-xl p-6 border border-slate-200/80 shadow-xs space-y-4 relative overflow-hidden">
                ...
                <div class="bg-white rounded-xl p-6 border border-slate-200/80 shadow-xs space-y-4 relative overflow-hidden">
                    ...
                    <div class="space-y-2.5 font-inter text-xs">
                        <button type="button" class="w-full bg-primary hover:bg-primary-dark text-white font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 shadow-xs transition-colors min-h-[44px] cursor-pointer">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>
                            </svg>
                            Save Settings
                        ...
                        <button type="button" class="w-full border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-medium py-2.5 px-4 rounded-lg flex items-center justify-center transition-colors min-h-[44px] cursor-pointer">
                            Reset Defaults
                        </button>
                    </div>
                </div>
