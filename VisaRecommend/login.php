        ...
        <div class="w-full max-w-md space-y-6">
            ...
            <form action="<?= BASE_URL ?>dashboard" method="GET" class="space-y-5 font-inter pt-2">
                ...
                <div class="flex items-center justify-between text-xs pt-1">
                    ...
                    <a href="#" class="text-primary hover:text-primary-dark font-medium transition-colors">Forget password?</a>
                </div>

                <!-- Log In Action Button -->
                <button type="submit" class="w-full bg-primary hover:bg-primary-dark text-white font-semibold text-sm py-3 px-4 rounded-lg shadow-xs transition-colors min-h-[44px] mt-2 cursor-pointer flex items-center justify-center">
                    Log in
                </button>

                <!-- Bottom Sign Up Link -->
                <p class="text-xs text-slate-500 text-center pt-2">
                    Don't have an account? <a href="#" class="text-primary hover:text-primary-dark font-semibold transition-colors">Sign up</a>
                </p>
            </form>
