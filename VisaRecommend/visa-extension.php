<?php
/**
 * Visa Extension Applications Page
 * Department of Christian Religious Affairs
 * Visa Recommendation Letter Management System
 */

$page_title = "Visa Extension Applications";

require_once __DIR__ . '/includes/header.php';
require_once __DIR__ . '/includes/sidebar.php';

// Visa Extension Applications Dataset
$applications = [
    [
        'id' => 'VLS-2629',
    ...
    [
        ...
        'church' => 'St. Francis Church • Mannar Diocese',
        'passport' => 'ZX9182734',
        'country' => '🇵🇹 Portugal',
...
<main class="flex-1 overflow-y-auto p-3.5 sm:p-6 lg:p-8 bg-[#FDFBF9]">
    <div class="max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <span class="text-xs font-normal text-slate-400 font-inter">Home / Visa Types / Visa Extension</span>
                <h2 class="text-xl sm:text-2xl font-bold text-slate-900 font-heading tracking-tight mt-0.5">Visa Extension Applications</h2>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div class="relative overflow-hidden bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
                ...
                <div>
                    <p class="text-xs font-medium text-slate-400 font-inter">Total Extensions</p>
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">274</h3>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">16</h3>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">9</h3>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-slate-900 font-heading mt-1.5">241</h3>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/90 shadow-2xs overflow-hidden">
            <div class="p-5 border-b border-slate-100 flex items-center justify-between">
                <h3 class="font-bold text-slate-900 font-heading text-lg">Visa Extension Applications</h3>
                <span class="text-xs text-slate-500 font-inter">Showing <strong class="font-semibold text-slate-800">3</strong> active visa extension records</span>
            </div>
