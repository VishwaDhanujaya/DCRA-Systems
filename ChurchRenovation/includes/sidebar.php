    ...
    <div class="py-5 px-3 space-y-6">
        ...
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a href="<?= BASE_URL ?>requests" <?= ($current_page === 'requests.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'requests.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Requests
                </a>
                <a href="<?= BASE_URL ?>approvals" <?= ($current_page === 'approvals.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'approvals.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    Approvals
                </a>
                <a href="<?= BASE_URL ?>projects" <?= ($current_page === 'projects.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'projects.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div>
            ...
            <nav class="space-y-1">
                <a href="<?= BASE_URL ?>gallery" <?= ($current_page === 'gallery.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'gallery.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a href="<?= BASE_URL ?>logout" class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg text-primary hover:bg-primary/10 focus:outline-none focus:ring-2 focus:ring-primary/40 font-heading transition-all duration-150 mt-2">
