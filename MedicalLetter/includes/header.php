...
$page_title = $page_title ?? 'Free of Charge Medical Letter Issuing System';
$user = current_user();
?>
<!DOCTYPE html>
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden sm:block">
                    <h1 class="text-sm sm:text-base font-bold text-slate-900 font-heading tracking-tight leading-tight">Free of Charge Medical Letter Issuing</h1>
                </div>
            </div>
