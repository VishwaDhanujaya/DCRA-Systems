    ...
    <div class="py-5 px-3 space-y-6">
        ...
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a href="<?= BASE_URL ?>medical-letters" <?= ($current_page === 'medical-letters.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'medical-letters.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 opacity-75" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Medical Letters
                </a>
                <a href="<?= BASE_URL ?>new-medical-letter" <?= ($current_page === 'new-medical-letter.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'new-medical-letter.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 <?= ($current_page === 'new-medical-letter.php') ? 'opacity-90' : 'opacity-75' ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
        ...
        <div>
            ...
            <nav class="space-y-1">
                <a href="#" class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter transition-all duration-150">
                    <svg class="mr-3 h-4 w-4 opacity-75" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
            ...
            <nav class="space-y-1">
                <a href="<?= BASE_URL ?>reports" <?= ($current_page === 'reports.php') ? 'aria-current="page"' : '' ?> class="flex items-center min-h-[44px] px-3 py-2.5 text-xs font-semibold rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/40 <?= ($current_page === 'reports.php') ? 'bg-primary text-white shadow-xs font-heading' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-inter' ?>">
                    <svg class="mr-3 h-4 w-4 <?= ($current_page === 'reports.php') ? 'opacity-90' : 'opacity-75' ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 2v-6m-8 10h12a2 2 0 002-2V9a2 2 0 00-2-2h-3l-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    Reports
                </a>
