...
$page_title = $page_title ?? 'Online Bungalow Booking System';
$user = current_user();
?>
<!DOCTYPE html>
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden sm:block">
                    <h1 class="text-sm sm:text-base font-bold text-slate-900 font-heading tracking-tight leading-tight">Thalawila Pilgrim House Online Booking</h1>
                </div>
            </div>
