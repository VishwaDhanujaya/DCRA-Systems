<?php
/**
 * Resort Management Page - Exact Visual Recreation matching Target Image
 * Department of Christian Religious Affairs
 * Online Bungalow Booking System
 */

$page_title = "Resort Management";
...
<main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-[#F8FAFC]">
    <div class="max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <span class="text-xs font-medium text-slate-400 font-inter">Home / Resort Management</span>
                <h2 class="text-2xl font-bold text-slate-900 font-heading tracking-tight mt-0.5">Resort Management</h2>
            </div>
        ...
        <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs space-y-6">
            <h3 class="text-lg font-bold text-slate-900 font-heading">All Resorts</h3>
                    ...
                    <table class="min-w-full text-left text-xs font-inter border-collapse">
                        <thead>
                            <tr class="bg-[#F5F2EB] text-[#8C8473] font-semibold border-b border-slate-200/40">
                                <th scope="col" class="py-3 px-4 rounded-l-lg tracking-wider text-[10px]">ROOM</th>
                                <th scope="col" class="py-3 px-4 tracking-wider text-[10px]">TYPE</th>
                                <th scope="col" class="py-3 px-4 tracking-wider text-[10px]">PRICE / NIGHT</th>
                                <th scope="col" class="py-3 px-4 tracking-wider text-[10px]">MAX GUESTS</th>
                                <th scope="col" class="py-3 px-4 tracking-wider text-[10px]">AVAILABILITY</th>
                        ...
                        <tbody class="divide-y divide-slate-100 text-slate-700">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="py-4 px-4">
                                    <div class="font-bold text-slate-800">TPH - R01</div>
                                    <div class="text-slate-400 text-[10px] mt-0.5">AC</div>
                                </td>
                                <td class="py-4 px-4 text-slate-500">Single Room</td>
                                <td class="py-4 px-4 font-semibold text-slate-800">LKR 2,000.00</td>
                                <td class="py-4 px-4 text-slate-500 font-mono">02</td>
                                <td class="py-4 px-4">
                                    <span class="bg-[#FEF3C7] text-[#92400E] text-[10px] px-2.5 py-1 rounded-md font-semibold tracking-wide">Available</span>
                                </td>
                                <td class="py-4 px-4">
                                ...
                                <td class="py-4 px-4">
                                    <div class="flex items-center justify-center gap-1">
                                        <button class="inline-flex items-center justify-center p-1.5 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer" aria-label="View resort details">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="py-4 px-4">
                                    <div class="font-bold text-slate-800">TPH - R02</div>
                                    <div class="text-slate-400 text-[10px] mt-0.5">AC</div>
                                </td>
                                <td class="py-4 px-4 text-slate-500">Double Room</td>
                                <td class="py-4 px-4 font-semibold text-slate-800">LKR 3,000.00</td>
                                <td class="py-4 px-4 text-slate-500 font-mono">03</td>
                                <td class="py-4 px-4">
                                    <span class="bg-[#FEE2E2] text-[#991B1B] text-[10px] px-2.5 py-1 rounded-md font-semibold tracking-wide">Not-Available</span>
                                </td>
                                <td class="py-4 px-4">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="py-4 px-4">
                                    <div class="font-bold text-slate-800">TPH - R03</div>
                                    <div class="text-slate-400 text-[10px] mt-0.5">NON-AC</div>
                                </td>
                                <td class="py-4 px-4 text-slate-500">Single Room</td>
                                <td class="py-4 px-4 font-semibold text-slate-800">LKR 2,000.00</td>
                                <td class="py-4 px-4 text-slate-500 font-mono">02</td>
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="py-4 px-4">
                                    <div class="font-bold text-slate-800">TPH - R04</div>
                                    <div class="text-slate-400 text-[10px] mt-0.5">AC</div>
                                </td>
                                <td class="py-4 px-4 text-slate-500">Double Room</td>
                                <td class="py-4 px-4 font-semibold text-slate-800">LKR 3,000.00</td>
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="py-4 px-4">
                                    <div class="font-bold text-slate-800">TPH - R05</div>
                                    <div class="text-slate-400 text-[10px] mt-0.5">NON-AC</div>
                                </td>
                                <td class="py-4 px-4 text-slate-500">Single Room</td>
                                <td class="py-4 px-4 font-semibold text-slate-800">LKR 4,000.00</td>
                                <td class="py-4 px-4 text-slate-500 font-mono">02</td>
                                <td class="py-4 px-4">
                                    <span class="bg-[#FEF3C7] text-[#92400E] text-[10px] px-2.5 py-1 rounded-md font-semibold tracking-wide">Available</span>
                                </td>
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="py-4 px-4">
                                    <div class="font-bold text-slate-800">TPH - R06</div>
                                    <div class="text-slate-400 text-[10px] mt-0.5">AC</div>
                                </td>
                                <td class="py-4 px-4 text-slate-500">Double Room</td>
                                <td class="py-4 px-4 font-semibold text-slate-800">LKR 2,000.00</td>
